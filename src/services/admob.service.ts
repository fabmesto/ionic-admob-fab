...
export class AdmobService {
  ...
  public platform: 'ios' | 'android' | 'web' = 'web';
  ...
  async resumeBanner() {
    if (this.nascondiADV == false && this.isRealDevice()) {
  ...
  async prepareConfigInterstitial() {
    ...
    if (this.isLoadingInterstitial == false && this.isRealDevice()) {
      try {
